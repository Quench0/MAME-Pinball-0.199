...
/*-----------------------------------------
/ Centaur II #1370 - same ROMset as Centaur
/------------------------------------------*/
...
/ 301/Bulls Eye
/-------------------------------*/
ROM_START(bullseye)                     // Darts 301 based scoring
...
ROM_START(futrquen)
	ROM_REGION(0x10000, "maincpu", 0)
#if 1
	ROM_LOAD("mpu_u2_256.bin", 0xc000, 0x4000, CRC(ce2e6b58) SHA1(746e264f7d2f80ce81e30e6962baa7c0a391e696))
