...
public:
	...
	void by17_35(machine_config &config);
	void by17_barakandl(machine_config &config);
...
protected:
	...
	void by17_35_map(address_map &map);
	void by17_barakandl_map(address_map &map);
...
void by17_state::by17_35_map(address_map &map)
{
	map.unmap_value_high();
	...
	map(0x0200, 0x02ff).mirror(0x6d00).ram().rw(FUNC(by17_state::nibble_nvram_r), FUNC(by17_state::nibble_nvram_w)).share("nvram");
	map(0x1000, 0x1fff).mirror(0x2000).rom();
	map(0x5000, 0x5fff).mirror(0x2000).rom();
}

void by17_state::by17_barakandl_map(address_map &map)
{
	map.unmap_value_high();
	...
	map(0x0100, 0x0fff).ram().rw(FUNC(by17_state::nibble_nvram_r), FUNC(by17_state::nibble_nvram_w)).share("nvram");
...
static INPUT_PORTS_START( blackjckf )
	PORT_INCLUDE( blackjck )

	PORT_MODIFY("DSW2")
	PORT_DIPNAME( 0x03, 0x01, "Maximum Credits")                        PORT_DIPLOCATION("SW2:!1,!2")	/// DSW:17,18
	PORT_DIPSETTING(    0x00, "5")													///
	PORT_DIPSETTING(    0x01, "10")													///
	PORT_DIPSETTING(    0x02, "20")													///
	PORT_DIPSETTING(    0x03, "99 (Freeplay)")										///
	PORT_DIPNAME( 0x04, 0x00, "Player Displays")                        PORT_DIPLOCATION("SW2:!3")		/// DSW:19
...
static INPUT_PORTS_START( eightbllf )
	PORT_INCLUDE( eightbll )
...
static INPUT_PORTS_START( mataharif )
	PORT_INCLUDE( matahari )
	...
	PORT_MODIFY("DSW3")
	PORT_DIPNAME( 0x10, 0x00, "Alternate Extra Ball Awards")            PORT_DIPLOCATION("SW3:!5")
	PORT_DIPSETTING(    0x00, DEF_STR( Off ))																				// Factory Mode
	PORT_DIPSETTING(    0x10, DEF_STR( On ))																				// New Mode
	PORT_DIPNAME( 0x60, 0x60, "Extra Ball / Specials Award Mode")       PORT_DIPLOCATION("SW3:!6,!7")
	PORT_DIPSETTING(    0x00, "50,000 / 50,000" )                       PORT_CONDITION("DSW3", 0x10, EQUALS, 0x00)			// Factory Mode
	PORT_DIPSETTING(    0x20, "Extra Ball / 50,000" )                   PORT_CONDITION("DSW3", 0x10, EQUALS, 0x00)
	PORT_DIPSETTING(    0x40, "Extra Ball / Extra Ball" )               PORT_CONDITION("DSW3", 0x10, EQUALS, 0x00)
	PORT_DIPSETTING(    0x60, "Extra Ball / Replay" )                   PORT_CONDITION("DSW3", 0x10, EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "25,000 / 50,000" )                       PORT_CONDITION("DSW3", 0x10, NOTEQUALS, 0x00)		// New Mode
	PORT_DIPSETTING(    0x20, "25,000 / Extra Ball" )                   PORT_CONDITION("DSW3", 0x10, NOTEQUALS, 0x00)
	PORT_DIPSETTING(    0x40, "Extra Ball / Extra Ball" )               PORT_CONDITION("DSW3", 0x10, NOTEQUALS, 0x00)
	PORT_DIPSETTING(    0x60, "Extra Ball / Replay" )                   PORT_CONDITION("DSW3", 0x10, NOTEQUALS, 0x00)
INPUT_PORTS_END
...
static INPUT_PORTS_START( stk_sprsf )
	PORT_INCLUDE( stk_sprs )
...
MACHINE_CONFIG_START(by17_state::by17_35)
	by17(config);

	MCFG_DEVICE_MODIFY("maincpu")
	MCFG_DEVICE_PROGRAM_MAP(by17_35_map)
MACHINE_CONFIG_END


MACHINE_CONFIG_START(by17_state::by17_barakandl)
	by17(config);

	MCFG_DEVICE_MODIFY("maincpu")
	MCFG_DEVICE_PROGRAM_MAP(by17_barakandl_map)
MACHINE_CONFIG_END
...
ROM_START(freedomt)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "720-09_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "720-07_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END

ROM_START(freedom20t)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "freedom20t_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "freedom20t_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END
...
ROM_START(nightrdrt)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "nightrdrt_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "nightrdrt_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END
...
ROM_START(blackjckt)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "blackjckt_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "blackjckt_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END

ROM_START(blackjckf)
	ROM_REGION(0x8000, "maincpu", 0)
	ROM_LOAD( "blackjckf_2.732", 0x1000, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5000, 0x0800)
	ROM_LOAD( "blackjckf_6.732", 0x1800, 0x0800, CRC(00000000))
...
ROM_START(blackjckn)
	...
	ROM_LOAD( "bj-tourn.27512", 0x1000, 0x1000, CRC(2561007a) SHA1(7f7c7ffbcbbe22ae5e1876027884679fee02a672))
...
ROM_START(evelkniet)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "evelkniet_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "evelkniet_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END
...
ROM_START(mataharit)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "mataharit_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "mataharit_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END

ROM_START(mataharb)
	ROM_REGION(0x8000, "maincpu", 0)
	ROM_LOAD( "mata2732.u2", 0x1000, 0x0800, CRC(8d2db062) SHA1(7ccce6633fe16ec82ad387cd7e0913cf89be0cb1))
	ROM_CONTINUE( 0x5000, 0x0800)
	ROM_LOAD( "72132fn.u6",  0x1800, 0x0800, CRC(dad6fdf1) SHA1(66046454d3b56aac52fcb303fd7bb7ef33296982))
	ROM_CONTINUE( 0x5800, 0x0800)
	ROM_COPY("maincpu", 0x5FF8, 0x7FF8,0x08)
ROM_END
...
ROM_START(mataharif)
	ROM_REGION(0x8000, "maincpu", 0)
	ROM_LOAD( "mataharif_2.732", 0x1000, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5000, 0x0800)
	ROM_LOAD( "mataharif_6.732", 0x1800, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5800, 0x0800)
	ROM_COPY("maincpu", 0x5FF8, 0x7FF8,0x08)
ROM_END
...
ROM_START(mataharin)
	ROM_REGION(0x10000, "maincpu", 0)
	ROM_LOAD( "mataharif.27512", 0x1000, 0x1000, CRC(00000000))
	ROM_CONTINUE( 0x1000, 0xf000)
...
ROM_START(eightbllt)   // Fixes exploit in previous version - next ball will not be served until the Tilt switch is released
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "eightbllt_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "eightbllt_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END
...
ROM_START(eightbllf)
	ROM_REGION(0x8000, "maincpu", 0)
	ROM_LOAD( "eightbllf_2.732", 0x1000, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5000, 0x0800)
	ROM_LOAD( "eightbllf_6.732", 0x1800, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5800, 0x0800)
	ROM_COPY("maincpu", 0x5FF8, 0x7FF8,0x08)
ROM_END
...
ROM_START(pwerplayt)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "pwerplayt_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "pwerplayt_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END

ROM_START(pwerplayf)
	ROM_REGION(0x8000, "maincpu", 0)
	ROM_LOAD( "pwerplayf_2.732", 0x1000, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5000, 0x0800)
	ROM_LOAD( "pwerplayf_6.732", 0x1800, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5800, 0x0800)
	ROM_COPY("maincpu", 0x5FF8, 0x7FF8,0x08)
ROM_END
...
ROM_START(stk_sprst)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "stk_sprs20t_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "stk_sprs20t_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END

ROM_START(stk_sprs21t)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "stk_sprs21t_2.716", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "stk_sprs21t_6.716", 0x1800, 0x0800, CRC(00000000))
ROM_END

ROM_START(stk_sprsf)
	ROM_REGION(0x8000, "maincpu", 0)
	ROM_LOAD( "stk_sprsf_2.732", 0x1000, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5000, 0x0800)
	ROM_LOAD( "stk_sprsf_6.732", 0x1800, 0x0800, CRC(00000000))
	ROM_CONTINUE( 0x5800, 0x0800)
	ROM_COPY("maincpu", 0x5FF8, 0x7FF8,0x08)
ROM_END
...
ROM_START(sco_test)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "scotest8.716", 0x1800, 0x0800, CRC(D79FEB21))
ROM_END


/*--------------------------------
/ 32kbit ROM/RAM qualification test
/-------------------------------*/
ROM_START(32ktest)
	ROM_REGION(0x2000, "maincpu", 0)
	ROM_LOAD( "32ktest_full.u2", 0x1000, 0x0800, CRC(00000000))
	ROM_LOAD( "32ktest_full.u6", 0x1800, 0x0800, CRC(00000000))
ROM_END
...
GAMEL( 1977, freedomt,     freedom,    by17,      freedom,   freedom_state,   init_by17,    ROT0, "Bally", "Freedom TEST",                                  MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_freedom)
GAMEL( 1977, freedom20t,   freedom,    by17,      freedom,   freedom_state,   init_by17,    ROT0, "Bally", "Freedom TEST (rev. 20 U6)",                     MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_freedom)
...
GAMEL( 1977, nightrdrt,    nightrdr,   by17,      nightrdr,  nightrdr_state,  init_by17,    ROT0, "Bally", "Night Rider (rev. 21) TEST",                    MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_nightrdr)
...
GAMEL( 1978, blackjckt,    blackjck,   by17,      blackjck,  blackjck_state,  init_by17,    ROT0, "Bally", "Black Jack (Pinball) TEST",                     MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_blackjck)
GAMEL( 1978, blackjckf,    blackjck,   by17_35,   blackjckf, blackjck_state,  init_by17,    ROT0, "Bally", "Black Jack (Pinball) TEST -35 ROM addressing",  MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_blackjck)
GAMEL( 1978, blackjckn,    blackjck,   by17_barakandl,   blackjckf, blackjck_state,  init_by17,    ROT0, "Bally", "Black Jack (Pinball) Tournament BARAKANDL ROM addressing",  MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_blackjck)
...
GAMEL( 1977, evelkniet,    evelknie,   by17,      evelknie,  evelknie_state,  init_by17,    ROT0, "Bally", "Evel Knievel TEST",                             MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_evelknie)
...
GAMEL( 1978, mataharit,    matahari,   by17,      matahari,  matahari_state,  init_by17,    ROT0, "Bally", "Mata Hari TEST",                                MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_matahari)
GAMEL( 1978, mataharb,     matahari,   by17_35,   matahari,  matahari_state,  init_by17,    ROT0, "Bally", "Mata Hari Oliver Freeplay",                     MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_matahari)
GAMEL( 1978, mataharif,    matahari,   by17_35,   mataharif, matahari_state,  init_by17,    ROT0, "Bally", "Mata Hari TEST -35 ROM addressing",             MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_matahari)
GAMEL( 1978, mataharin,    matahari,   by17_barakandl, mataharif, matahari_state,  init_by17,    ROT0, "Bally", "Mata Hari TEST BARAKANDL ROM addressing",  MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_matahari)
...
GAMEL( 1977, eightbllt,    eightbll,   by17,      eightbll,  eightbll_state,  init_by17,    ROT0, "Bally", "Eight Ball (rev. 20) TEST",                     MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_eightbll)
GAMEL( 1977, eightbllf,    eightbll,   by17_35,   eightbllf, eightbll_state,  init_by17,    ROT0, "Bally", "Eight Ball (rev. 20) TEST -35 ROM addressing",  MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_eightbll)
...
GAMEL( 1978, pwerplayt,    pwerplay,   by17,      pwerplay,  pwerplay_state,  init_by17,    ROT0, "Bally", "Power Play (Pinball) TEST",                     MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_pwerplay)
GAMEL( 1978, pwerplayf,    pwerplay,   by17_35,   pwerplay,  pwerplay_state,  init_by17,    ROT0, "Bally", "Power Play (Pinball) TEST -35 ROM addressing",  MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_pwerplay)
...
GAMEL( 1978, stk_sprst,    stk_sprs,   by17,      stk_sprs,  stk_sprs_state,  init_by17,    ROT0, "Bally", "Strikes and Spares 20 TEST",                    MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_stk_sprs)
GAMEL( 1978, stk_sprs21t,  stk_sprs,   by17,      stk_sprs,  stk_sprs_state,  init_by17,    ROT0, "Bally", "Strikes and Spares 21 TEST",                    MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_stk_sprs)
GAMEL( 1978, stk_sprsf,    stk_sprs,   by17_35,   stk_sprsf, stk_sprs_state,  init_by17,    ROT0, "Bally", "Strikes and Spares TEST -35 ROM addressing",    MACHINE_MECHANICAL | MACHINE_NOT_WORKING, layout_by17_stk_sprs)
GAME(  2012, sco_test,     0,          by17,      by17,      by17_state,      init_by17,    ROT0, "Bally", "SCO TEST ROM",                                  MACHINE_MECHANICAL | MACHINE_NOT_WORKING)

GAME(  2023, 32ktest,      0,          by17,      by17,      by17_state,      init_by17,    ROT0, "Quench","TEST 32kbit 4kByte ROM",                        MACHINE_MECHANICAL | MACHINE_NOT_WORKING)
